    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> Create(OrderCreateViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    // Get customer and product details from the database.
                    ...
                    // If customer or product is missing, add a model error and return the view.
                    ...
                    // Send a queue message for the new order.
                    ...
                    // Send a separate message for stock updates.
                    ...
                    // Set a temporary success message and redirect to the index page.
                    TempData["Success"] = "Order created successfully!";
                    return RedirectToAction(nameof(Index));
                }
                catch (Exception ex)
                {
                    // If an error occurs, add an error message to the model state and return the view.
