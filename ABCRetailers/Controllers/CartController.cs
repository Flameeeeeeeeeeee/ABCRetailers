...
namespace ABCRetailers.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                var product = await _api.GetProductAsync(item.ProductId); if (product == null) continue;
        ...
        public async Task<IActionResult> Checkout()
        {
            ...
            // The image cuts off here, but you'll need a final redirect.
            // This is the logical next step:
            TempData["Success Message"] = "Order placed successfully";
            return RedirectToAction("Confirmation");
        }

        public IActionResult Confirmation()
        {
            ViewBag.Message = TempData["Success Message"] ?? "Thank you for your purchase";
            return View();
        }
