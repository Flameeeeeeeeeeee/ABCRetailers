...
namespace ABCRetailers.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> InitializeStorage()
        {
            try
            {
                //force re-initializaton of storage
                await _storageService.GetAllEntitiesAsync<Customer>();// triggers initialization
                TempData["Success"] = "Azure Storage initialization successfully";
