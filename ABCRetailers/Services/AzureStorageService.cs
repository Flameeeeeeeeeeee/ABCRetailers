    ...
    public class AzureStorageService : IAzureStorageService
    {
        ...
        private async Task InitializeStorageAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw; //re-throw, make error visible
            }
        }
        //Tale Operations
        ...
        public async Task<T> UpdateEntityAsync<T>(T entity) where T : class, ITableEntity
        {
            ...
            catch (Azure.RequestFailedException ex) when (ex.Status == 412)
            {
                ...
                _logger.LogWarning("Update entity failed due to ETag mismatch for {EntityType} with RowKey {RowKey}",
