...
namespace ABCRetailersFunctions.Functions
{
    public class ProductsFunctions
    {
        ...
        public ProductsFunctions(TableClient tableClient, ILogger<ProductsFunctions> logger)
        {
        ...
        {
            var products = _tableClient.Query<ProductEntity>().Select(Map.ToDto).ToList();
        ...
        public async Task<HttpResponseData> Get([HttpTrigger(AuthorizationLevel.Function, "get", Route = "products/{id}")] HttpRequestData req, string id)
        {
            ...
            try
            {
                var entity = await _tableClient.GetEntityAsync<ProductEntity>("Product", id);
        ...
        public async Task<HttpResponseData> Update([HttpTrigger(AuthorizationLevel.Function, "put", Route = "products/{id}")] HttpRequestData req, string id)
        {
            ...
            try
            {
                var existing = await _tableClient.GetEntityAsync<ProductEntity>("Product", id);
